...
export const Topic: React.FC<TopicProps> = props => {
    return (
        <div className="topic">
            <StyledInputText color="secondary" className="topicText" id="standard-basic" label="Enter a topic" value={props.topic} onChange={(e) => props.setTopic(e.target.value)} multiline></StyledInputText>
